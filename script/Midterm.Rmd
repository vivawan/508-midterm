...
```{r category mean plot, echo=TRUE, message=FALSE, warning=FALSE, fig.height=10}
...
bothregressions %>%
  ...
  stat_smooth(aes(price, price), 
             method = "lm", se = FALSE, size = 0.8, color="#b2182b") + 
  stat_smooth(aes(price, price.predict), 
              method = "lm", se = FALSE, size = 0.8, color="#2166ac") +
...
ggplot() +
  geom_sf(data = st_intersection(acsTractsSeattle.2015, seattle), fill = "#ECECEC", color = "#2166ac", linewidth = 0.2) +
    geom_sf(data = st_as_sf(bothregressions.error),
          aes(color = cut(price.AbsError, breaks = breaks_quantiles$brks, include.lowest = TRUE)), size = 0.5) +
  scale_color_manual(values = colors,
                    labels = labels,
...
- source:https://data-seattlecitygis.opendata.arcgis.com/datasets/531976f80bd74c0992ba9079e4d86e2a_0/explore?location=47.614414%2C-122.336918%2C11.54

### Small Neighborhoods

- source:https://data-seattlecitygis.opendata.arcgis.com/datasets/b4a142f592e94d39a3bf787f3c112c1d_0/explore?location=47.614414%2C-122.336918%2C11.54