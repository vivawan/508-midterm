...
```{r house_location, echo=FALSE, message=FALSE}
# import house data
...
```{r internal, message=FALSE, warning=FALSE, include=FALSE}
...
```{r socio-economic variable, results='hide', include=FALSE}
...
```{r category mean plot, echo=FALSE}
...
**Location by Waterfront **
```{r water_dum_sum,echo=FALSE}
### water_dum 
house %>%
  st_drop_geometry() %>%
  group_by(water_dum) %>%
...
```{r median_hh_dum_sum, echo=FALSE}
### median_hh_dum
house %>%
  st_drop_geometry() %>%
...
lm14.2 <- lm(price ~ .-crime_dis2-crime_dis3-crime_dis4-crime_dis5-key, data = house)
lm14.3 <- lm(price ~ .-crime_dis2-crime_dis3-crime_dis4-crime_dis5-key, data = house)
lm14.4 <- lm(price ~ .-crime_dis2-crime_dis3-crime_dis4-crime_dis5-key, data = house)
lm14.5 <- lm(price ~ .-crime_dis2-crime_dis3-crime_dis4-crime_dis5-key, data = house)
lm14.6 <- lm(price ~ .-crime_dis2-crime_dis3-crime_dis4-crime_dis5-key, data = house)
summary(lm14)
