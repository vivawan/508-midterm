...
### Exploration with ref to amenities?

I assume the intention of asking us to engineer and test amenities is to find they are perfectly correlated with stations (start_station), thus in the final model we keep station only.

See text book **8.2.6 What about distance features?**
...
**Note**: station fixed effect is kept in lieu of other amenities feature, since it would have accounted for those locational impacts - will add exploratory tests
